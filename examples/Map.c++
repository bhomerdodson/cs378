...
int main () {
    ...
    transform(a, a + s, x, sqre_1);
    assert(equal(x, x + s, b));
    transform(a, a + s, x, cube_1);
    ...
    transform_2(a, a + s, x, sqre_1);
    assert(equal(x, x + s, b));
    transform_2(a, a + s, x, cube_1);
    assert(equal(x, x + s, c));

    transform(a, a + s, x, sqre_2());
    assert(equal(x, x + s, b));
    transform(a, a + s, x, cube_2());
    assert(equal(x, x + s, c));

//  transform_1(a, a + s, x, sqre_2()); // error: cannot convert 'sqre_2' to 'int (*)(int)' for argument '4' to 'int* transform_1(const int*, const int*, int*, int (*)(int))'
//  assert(equal(x, x + s, b));
...
//  assert(equal(x, x + s, c));
    ...
    transform_2(a, a + s, x, sqre_2());
    assert(equal(x, x + s, b));
    transform_2(a, a + s, x, cube_2());
    assert(equal(x, x + s, c));
